...
const Footer = () => {
  return (
    <footer className="flex flex-col text-black-100 border-t mt-5 border-gray-100 ">
       <div className="flex max-md:flex-col flex-wrap justify-between gap-5 sm:px-16 px-6 py-10 xl:flex-col">
         ...
         <div className="footer__links">
           ...
           <div className="flex justify-between items-center flex-wrap mt-10 border-t sm:px-16 px-6 py-10">
             <div className="footer__copyrights-link xl:justify-between">
